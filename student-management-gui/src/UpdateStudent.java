...
public class UpdateStudent extends javax.swing.JFrame {
    ...
    public UpdateStudent(StudentMain studentmain) {
        initComponents();
        stmain = studentmain;
    ...
    private void initComponents() {
        ...
        updateStudent.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(updateStudent, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void updateStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateStudentActionPerformed
        ...
        int prfMarks = Integer.parseInt( inputPrf.getText());
        int dbmsMarks = Integer.parseInt(inputDbms.getText());
        
        int index = stmain.serchStudentMethodInMainReturnIndex(id);
        
        if (index != -1){
           stmain.updateStudentArray(index, name, prfMarks, dbmsMarks);
        }
